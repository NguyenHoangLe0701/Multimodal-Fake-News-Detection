...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      localStorage.setItem('user:v1', JSON.stringify({ 
        email: userEmail, 
        name: userMeta.full_name || 'Administrator',
        role: userRole
      }));
  ...
  return (
    <AuthLayout 
      ...
      subtitle="Đăng nhập vào tài khoản của bạn để tiếp tục kiểm tra tin tức."
    >
      ...
      <p className="mt-8 text-center text-slate-500 font-medium text-sm">
        Chưa có tài khoản?{' '}
        <Link to="/register" className="text-[#2563EB] font-bold hover:text-blue-700 transition-colors">
          Đăng ký ngay
        </Link>
      </p>
    </AuthLayout>
