...
const newsFeatures = [
  {
    ...
    title: 'NLP — Ngữ nghĩa',
    body: 'Sử dụng mô hình Transformer (BERT) được fine-tune trên tập dữ liệu khổng lồ. Hệ thống phân tích sâu sắc các mẫu ngôn ngữ thường gặp trong thông tin sai lệch.',
  },
  {
    icon: ImageIcon,
    ...
    title: 'CNN — Hình ảnh',
    body: 'Sử dụng mạng CNN (ResNet50) để quét các dấu hiệu cắt ghép, giả mạo, hoặc sự bất nhất về điểm ảnh mà mắt thường khó nhận ra trên không gian 2D.',
  },
  {
    icon: Network,
    ...
    title: 'Late Fusion — Đa phương thức',
    body: 'Sức mạnh cốt lõi. Cross-reference feature vectors giữa văn bản và ảnh qua dense layer để phát hiện "Out of Context" fakes — ảnh thật đi kèm caption sai.',
  },
];
